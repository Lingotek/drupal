...
use Drupal\lingotek\Plugin\LingotekFormComponent\Field\ContentType;
use Drupal\Tests\UnitTestCase;

/**
 * Unit test for the bundle field form component.
 *
 * @coversDefaultClass \Drupal\lingotek\Plugin\LingotekFormComponent\Field\ContentType
 * @group lingotek
 * @preserve GlobalState disabled
 */
class ContentTypeTest extends UnitTestCase {

  /**
   * The class instance under test.
   *
   * @var \Drupal\lingotek\Plugin\LingotekFormComponent\Field\ContentType
   */
  protected $field;
  ...
  protected function setUp(): void {
    ...
    $this->field = new ContentType([], 'content_type', [], $this->entityTypeManager, $this->languageManager, $this->lingotekConfiguration, $this->lingotekContentTranslation, $this->entityTypeBundleInfo);
  ...
  public function testGetHeader() {
    ...
    $this->assertSame('Content Type', $header->getUntranslatedString());
  }
  ...
  public function testGetData() {
    ...
    $this->assertSame('My Entity Type', $this->field->getData($entity));
  }
