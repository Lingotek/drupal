...
class LingotekNodeBulkFormWithGroupModuleTest extends LingotekTestBase {
   ...
   * {@inheritdoc}
   */
  public static $modules = ['block', 'node', 'group', 'gnode', 'lingotek_group_test'];
  ...
  public function testGroupFilter() {
    ...
    for ($i = 1; $i < 15; $i++) {
      ...
      $edit = [];
      $edit['title[0][value]'] = new FormattableMarkup('Llamas are cool @i at Group @group', ['@group' => $this->groups[$group], '@i' => $i]);
