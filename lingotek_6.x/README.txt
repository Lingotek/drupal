...
Configuration:
	...
	1.  Permissions:
		...
		4.  Under lingotek module:
			...
			3.	phase_template - This allows a page creator to set which phase template
				(workflow) an individual page should use.  Enable this for the role you
				wish to be able to overwrite the default phase template setting on a
				page-by-page basis.
			4.  review_phase - This allows a user to click on the review phases, or tasks,
			...
			7.  translation_phase - This allows a user to click on the translation phases,
...
Usage:
	...
	5.  The title only appears once the page
		has been fully translated and reviewed (Total % = 100%) or machine translated
		or synced.
	...
	6.  Phase shows us what step in the workflow the document is on.
		The first phase of any phase set will need "translation_phase" permissions to
		complete.  The following phases are only accessible to those with
