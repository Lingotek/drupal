 ...
 * )
 */
class NestedCohesionEntityReferenceRevisionsDetector extends PluginBase implements RelatedEntitiesDetectorInterface, ContainerFactoryPluginInterface {
  ...
  public function extract(ContentEntityInterface &$entity, array &$entities, array &$related, $depth, array $visited) {
    ...
    if ($depth > 0) {
      ...
      foreach ($field_definitions as $k => $definition) {
        ...
        if ($field_type === 'cohesion_entity_reference_revisions') {
