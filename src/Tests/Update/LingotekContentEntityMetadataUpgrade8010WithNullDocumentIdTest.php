 ...
 * @group lingotek
 */
class LingotekContentEntityMetadataUpgrade8010WithNullDocumentIdTest extends UpdatePathTestBase {
  ...
  protected function setDatabaseDumpFiles() {
    $this->databaseDumpFiles = [
      ...
      __DIR__ . '/../../../tests/fixtures/update/null-document-id-8010.php',
    ];
  }
  ...
  public function testContentEntityMetadataUpgrade() {
    ...
    $this->assertEqual(count($metadatas), 15, 'All metadatas were migrated, including the one without Lingotek document id.');
    ...
    $node = Node::load(3);
    $this->assertNull($content_translation->getDocumentId($node));
    $this->assertEqual(Lingotek::STATUS_CURRENT, $content_translation->getSourceStatus($node));
